...
def set_channel_embed(ctx):
    ...
    embed.add_field(name="welcome channel" , value="```lt set welcome [channel]```" , inline=False)
    ...
    embed.add_field(name="leave channel" , value="```lt set leave [channel]```" , inline=False)
